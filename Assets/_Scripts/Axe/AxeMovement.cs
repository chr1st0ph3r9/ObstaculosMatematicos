...
public class AxeMovement : MonoBehaviour
{
    ...
    public float masa = 1.0f;           // Masa del hacha para calcular energ�a
    ...
    void Start()
    {
        ...
        Debug.Log($"[P�ndulo] Per�odo aproximado: {periodo:F2} s");
        //Debug.Log($"[P�ndulo] Energ�a potencial inicial: {energiaPotencial:F2} J");
    }
